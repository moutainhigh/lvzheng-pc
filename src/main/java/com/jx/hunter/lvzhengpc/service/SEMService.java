...
public class SEMService {
	 ...
	 * sem投放
	 */
	private static final String sellid = "38837505628929";
	private static final int channel = 101;  //SEM渠道
	public void addSEMOrderByLvzheng(Long userid){
		OrderBuzForHunter.obfhunter.orderPlace(sellid, userid, "", channel);
	}
