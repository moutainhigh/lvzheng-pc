...
public class AddressController extends BaseController {
	...
	public ActionResult addressList(){
		...
		Object obj1 = MemcachedUtil.get("address_"+ptitle+"_"+price+"_"+local+"_"+pageon+"_list");
		Object obj2 = MemcachedUtil.get("address_"+ptitle+"_"+price+"_"+local+"_"+pageon+"_pn");
		Object obj3 = MemcachedUtil.get("address_"+ptitle+"_"+price+"_"+local+"_"+pageon+"_pagecount");
		Object obj4 = MemcachedUtil.get("address_"+ptitle+"_"+price+"_"+local+"_"+pageon+"_condition");
		...
		if(CollectionUtils.isNotEmpty(addlist)){
			...
			System.out.println("address---from ---cached--finded-----");
		}else{
			...
			if(lvz != null && lvz.size() > 0){
				...
				try {
					prolist = ProductTitleService.stance.getProductlistBycondition(productcondition, pn, pagesize, "sell_addtime desc");
				} catch (Exception e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
				if(prolist != null && prolist.size() > 0){
					...
					MemcachedUtil.set("address_"+ptitle+"_"+price+"_"+local+"_"+pageon+"_list", prolist);
					MemcachedUtil.set("address_"+ptitle+"_"+price+"_"+local+"_"+pageon+"_pn", pn);
					MemcachedUtil.set("address_"+ptitle+"_"+price+"_"+local+"_"+pageon+"_pagecount", pagecount);
					MemcachedUtil.set("address_"+ptitle+"_"+price+"_"+local+"_"+pageon+"_condition", querycondition);
				}
			}
		}
